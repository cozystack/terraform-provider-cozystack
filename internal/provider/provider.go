...
func (p *CozystackProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		newAppResource[kubernetesNodesResourceModel, *kubernetesNodesResourceModel](client.KubernetesNodesResource(), "kubernetes_nodes", kubernetesNodesSchema),
		...
		newAppResource[backupPlanResourceModel, *backupPlanResourceModel](client.PlanResource(), "backup_plan", backupPlanSchema),
		newAppResource[restoreJobResourceModel, *restoreJobResourceModel](client.RestoreJobResource(), "restore_job", restoreJobSchema),
		newAppResource[rawSpecNsResourceModel, *rawSpecNsResourceModel](client.TenantGatewayResource(), "tenant_gateway", tenantGatewaySchema),
...
func (p *CozystackProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		newAppDataSource[kubernetesNodesModel, *kubernetesNodesModel](client.KubernetesNodesResource(), "kubernetes_nodes", kubernetesNodesDataSourceSchema),
		...
		newAppDataSource[backupPlanModel, *backupPlanModel](client.PlanResource(), "backup_plan", backupPlanDataSourceSchema),
		newAppDataSource[restoreJobModel, *restoreJobModel](client.RestoreJobResource(), "restore_job", restoreJobDataSourceSchema),
		newAppDataSource[rawSpecNsModel, *rawSpecNsModel](client.TenantGatewayResource(), "tenant_gateway", tenantGatewayDataSourceSchema),
