...
func TestRabbitmqFlatten_ExplicitLegacyPreset(t *testing.T) {
	t.Parallel()
	...
	if model.ResourcesPreset.ValueString() != "t1.nano" {
		t.Errorf("resourcesPreset = %q, want t1.nano", model.ResourcesPreset.ValueString())
	}
}
